...
-- NOTE: activity_records_worker_id_fkey DEFERRED to 09_add_worker_fks.sql (Batch 9.2).
...
-- NOTE: payroll_entries_worker_id_fkey DEFERRED to 09_add_worker_fks.sql (Batch 9.2).
